...
<xsl:stylesheet 
    ...
    <xsl:template match="/">
        ...
        <xsl:call-template name="cwrc_convert_range_date_to_period">
            ...
            <xsl:with-param name="to_date"></xsl:with-param>
        </xsl:call-template>
    ...
    <xsl:variable name="cwrc_year_four_digit" select="'#0000'"></xsl:variable>
    ...
    <xsl:template name="cwrc_convert_point_date_to_period">
        ...
        <xsl:variable name="year_str">
            <xsl:call-template name="cwrc_convert_ISO_8601_to_BCE_AD_year">
        ...
        <xsl:variable name="fromYear">
            <xsl:call-template name="cwrc_interval_start">
        ...
        <xsl:variable name="toYear">
            <xsl:call-template name="cwrc_interval_end">
                <xsl:with-param name="year_str" select="$year_str" />
            </xsl:call-template>
        </xsl:variable>
    ...
    <xsl:template name="cwrc_convert_range_date_to_period">
        ...
        <xsl:choose>
            <xsl:when test="$from_date='' and $to_date!=''">
                ...
                <xsl:call-template name="cwrc_convert_point_date_to_period">
                    <xsl:with-param name="point_date"><xsl:value-of select="$to_date"/></xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$from_date!='' and $to_date=''">
    ...
    <xsl:template name="cwrc_convert_ISO_8601_to_BCE_AD_year">
            ...
            <xsl:choose>
                <xsl:when test="starts-with($point_date,'-')">
                    ...
                    <xsl:variable name="year_only">
                        <xsl:call-template name="cwrc_convert_ISO_8601_year">
    ...
    <xsl:template name="cwrc_convert_ISO_8601_year">
        <xsl:param name="point_date"/>
    ...
    <xsl:template name="cwrc_interval_start">
    ...
    <xsl:template name="cwrc_interval_end">
        <xsl:param name="year_str" />
