       ...
       <!-- does a surname exist -->
        ...
        <xsl:variable name="name">
            ...
            <xsl:if test="mods:namePart[not(@type)]">
                <xsl:if test="mods:namePart[@type='family'] or mods:namePart[@type='given']">
                    <xsl:text> : </xsl:text>
                </xsl:if>
                <xsl:apply-templates select="mods:namePart[not(@type)]" mode="assemble_cwrc_title_author" />
            </xsl:if>
            ...
            <xsl:if test="
                ...
                <xsl:apply-templates select="
                    ...
                    | 
                    mods:role[mods:roleTerm[@type='text']!='']/mods:roleTerm"
                    mode="assemble_cwrc_title_author" 
                />
            </xsl:if>
        </xsl:variable>
